            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="publicInfoState" value="0" title="显示" checked>
                            <div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon layui-anim-scaleSpring"></i>
                                <div>显示</div>
                            </div>
                            <input type="radio" name="publicInfoState" value="1" title="隐藏" >
                    ...
                    <div class="layui-form-item">
                        <button class="layui-btn" type="button" lay-filter="publicInfoForm" lay-submit="">
                            保存
                        </button>
                    </div>
                    <!--</form>-->
...
<script>
        layui.use(["jquery", "upload", "form", "layer", "element"], function () {
            ...
            form.on('submit(publicInfoForm)', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: "<%=basePath%>/publicInfo/addPublicInfo",
                    dataType: 'json',
                    contentType: "application/json; charset=utf-8",
                    cache: true,
